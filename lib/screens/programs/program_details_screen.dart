...
class ProgramDetailsScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProgramsController>(
      builder: (programs) {
        final matching = programs.programs.where((element) => element.id == programId);
        final program = matching.isNotEmpty
            ? matching.first
            : (programs.programs.isNotEmpty ? programs.programs.first : null);
        if (program == null) {
