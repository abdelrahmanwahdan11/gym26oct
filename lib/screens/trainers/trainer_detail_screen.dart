...
class TrainerDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<TrainersController>(
      builder: (trainers) {
        final matching = trainers.trainers.where((element) => element.id == trainerId);
                ...
                children: [
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        Text(trainer.name, style: Theme.of(context).textTheme.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
